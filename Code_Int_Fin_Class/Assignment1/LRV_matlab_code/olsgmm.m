%function [bv,R2v,v] = olsgmm(lhv,rhv,lags,weight);
...
%  R2v    unadjusted
%  R2vadj adjusted R2!
%  [Chi squared statistic degrees of freedom pvalue] for all coeffs jointly zero. 
%   Note: tests whether first is a constant and ignores that one for test
